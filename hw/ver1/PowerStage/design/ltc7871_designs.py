...
low_side_cap = HybridCapacitor(ceramic=CGA6P1X7R1N106M250AC, num_ceramic=num_ceramic_caps,
                               electrolytic=C_220uF_100V, num_electrolytic=num_electrolytic_caps)

ltc7871_designs = [
    LTC7871Parameters(
        name="High power with high voltage differential",
        opp=opp_peak_stress,
        mosfet=MCAC80N10Y, inductor=PQ2614BLA4R7KND,
